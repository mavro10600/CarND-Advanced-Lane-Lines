...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  6 11:44:39 2019
...
plt.imsave('../output_images/undistort_test1.jpg', img_undist)

#%%

color_bin, s_bin, sx_bin= pipeline(img_undist)
plt.imsave('../output_images/thresholded_color_test1.jpg', color_bin)
#plt.imshow(color_bin)

#%%
binary_sum=np.add(sx_bin,s_bin)
binary_warped=warper(binary_sum, src, dst)
plt.imsave('../output_images/warped_test1.jpg', binary_warped)
...
def process_image_prior(img, left, right):
    ...
    if car_dev > 0:
        text1='dev: '+str(round(car_dev/100,2))+' meters to the left '
    elif car_dev <= 0:
        text1='dev: '+str(round(-car_dev/100,2))+' meters to the right '
...
#%%
imageclip=VideoFileClip('../project_video_processed_w_sliding_window.mp4')
imageclip.save_frame("../output_images/sliding_window.jpeg", t='00:00:40') 


#%%
imageclip=VideoFileClip('./output.avi')
imageclip.save_frame("../output_images/final_window.jpeg", t='00:00:40') 
